...
| `clone_strategy` | string | inherit | `clone` (the only supported value; inherits from settings) |
...
| `clone_strategy` | string | `clone` | Default clone strategy: `clone` (the only supported value) |
